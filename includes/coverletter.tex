...
\begin{minipage}{\textwidth}
  ...
  \begin{itemize}[leftmargin=.15in,rightmargin=.25in,itemsep=0.8mm]
	...
	\item Demonstrated collaborator of large-scale technical reports, including assisting with writing research grants and as a contributing editor of the soon-to-be-released \textit{MCNP6.2 User's Manual} (Pub. \ref{mcnp_manual})
	%\item Editor of the soon-to-be-released \textit{MCNP6.2 User's Manual}
	...
	%\item History collaborating with different universities and groups within the lab
	%\item 
	%\item  
